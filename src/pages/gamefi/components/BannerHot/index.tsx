...
const BannerHot = (props: objectT) => {
  const intl = useIntl();
  const btnText = intl.formatMessage({
    id: 'GAMEFI_BANNER_BTN',
  });
  const { hotListDatas = {}, dispatch } = props;
  const errorImg =
    ...
    <div className={styles['banner-hot']}>
      {
        ...
        >
          {hotListDatas.map((item: objectT, index: number) => {
            return (
                ...
                <section className={styles['banner']}>
                  <div className={styles['flex']}>
                    ...
                    <aside className={styles['intro-box']}>
                      ...
                      <Button type="primary" onClick={() => toDetail(item.id)}>
                        {btnText}
                        <RightOutlined />
                      </Button>
                    </aside>
      ...
      {
        <div className={styles['img-list-wrap']}>
